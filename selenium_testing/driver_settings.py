...
class TestSomething:
    ...
    def test_do_something(self, driver):
        # options = Options()
        # service = Service(executable_path='/Users/aaldoshina/Dev/praktikum_test/chromedriver')
...
#     search_form.search_input.search_with_wait('Moscow')
    WebDriverWait(driver, 5).until(
    expected_conditions.element_to_be_clickable((TestLocators.SEARCH_BUTTON))
